...
class TransactionController extends Controller
{
    ...
    public function complete($id)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Transaksi selesai diproses',
            'data' => $transaction,
            'code' => 200
        ]);
    }
...
//         // Kalau tidak pakai gateway:
//         // cash = langsung paid
//         // non-cash = bisa pilih mau langsung paid atau pending
...
//             'amount' => $total,
//             'paid_at' => $paymentStatus === Transaction::PAYMENT_PAID ? now() : null,
//         ]);
...
//             'success' => true,
//             'message' => 'Transaksi berhasil dibuat',
//             'data' => $transaction->load('transactionItems', 'payments')
//         ], 201);
